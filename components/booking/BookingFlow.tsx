            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    {Array.from({ length: room.capacity }, (_, i) => i + 1).map((guestCount) => (
      ...
      case 4: // Success
        return (
          ...
          >
            ...
            <h2 className="text-2xl font-bold mb-2">{t('bookingConfirmedTitle')}</h2>
        ...
        <div className="flex">
          ...
          <div className="hidden sm:block w-1/3 bg-gray-50 p-6 border-r">
            <div className="sticky top-6">
              ...
              <p className="text-sm text-gray-600 mt-1 mb-4">{room.categoryName}</p>
          ...
          <div className="flex-1 p-6 sm:p-8">
            <DialogHeader>
              <DialogTitle className="text-2xl">{t('bookingTitle')}</DialogTitle>
              ...
              <div className="flex items-center gap-4 my-6">
                {stepsConfig.map((s, index) => (
                  <React.Fragment key={s.id}>
                    ...
                    {index < stepsConfig.length - 1 && <div className="flex-1 h-0.5 bg-gray-200" />}
                  </React.Fragment>
                ))}
              </div>
            )}
